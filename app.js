(() => {
  ...
  const i18n = {
    ...
    en: {
      ...
      no: "No",
      hint: "Don't do this",
      hintBroken: "You'll break my heart",
      yay: "YAY!",
      ...
      surprisePhLabel: "Type your choice",
      surprisePh: "e.g. museum, ice cream...",
      needSurprise: "Type your choice 💕",
      activities: [
        { id: "dinner", label: "DINNER" },
        { id: "walk", label: "WALK" },
        { id: "coffee", label: "COFFEE" },
        { id: "surprise", label: "YOUR CHOICE" },
      ],
    },
  };
